...
<div className="w-full min-h-screen bg-gray-100 dark:bg-stone-950 flex flex-col pt-16">
  ...
  <div className="w-full bg-white dark:bg-stone-900 shadow-sm px-24 max-lg:px-6 max-md:px-4">
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 sm:px-6 py-2 gap-2 sm:gap-0">
      <span className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">
        ...
        <a href="#" className="hover:underline">Paid Membership</a>{" "} / Checkout
      </span>
    </div>
  ...
  <div className="w-[70%] mx-auto mt-10 pb-32 grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div className="lg:col-span-8 flex flex-col gap-6">
      {/* Billing */}
      <div className="bg-white dark:bg-stone-900 p-4 rounded shadow relative">
        <div className="flex justify-between items-center">
          <h1 className="inline-block text-lg font-semibold text-gray-800 dark:text-white">
            <span className="border-b-2 border-orange-400 pb-2">Billing</span> Details
          </h1>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            {[
              ...
              <div
                key={key}
                className={
                  ["academyName", "country", "address1", "address2"].includes(key)
                    ? "col-span-2"
                    : ""
                }
              >
      ...
      <div className="bg-white dark:bg-stone-900 p-4 rounded shadow">
        <h1 className="inline-block text-gray-800 dark:text-white">
          <span className="border-b-2 border-orange-400 pb-2">Select</span> Payment Method
        </h1>
        <form onSubmit={handleSubmit}>
          <div className="flex border border-gray-200 dark:border-gray-700 rounded mb-6 bg-gray-200 dark:bg-stone-800 mt-5">
          ...
          {paymentMethod === "card" && (
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="col-span-2">
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Holder Name</label>
                <input
                  type="text"
              ...
              <div className="col-span-2">
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Card Number</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Expiration Month</label>
                <select
              ...
              <div>
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Expiration Year</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">CVC</label>
                <input
                  type="text"
          ...
          {paymentMethod === "bank" && (
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="col-span-2">
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Bank Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">Account Number</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-1 text-sm font-medium text-gray-800 dark:text-gray-200">IBAN</label>
                <input
                  type="text"
  ...
  <div className="mt-6 mb-10 text-gray-600 dark:text-gray-300">
    <p className="mb-4">
      After payment via PayPal's secure checkout, you’ll receive a download link.
    </p>
    ...
    <div id="paypal-button-container"></div> {/* هنا هيتعمل render لزر PayPal */}
  </div>
)}

          {/* Order Details */}
          <h3 className="font-semibold mb-4 text-gray-800 dark:text-white">
            <span className="border-b-2 border-orange-400 pb-2">Order</span> Details
          </h3>
    ...
    <div className="lg:col-span-4">
      <div className="sticky top-24 bg-white dark:bg-stone-900 p-4 rounded shadow">
        <h1 className="inline-block text-gray-800 dark:text-white">
          <span className="border-b-2 border-orange-400 pb-2">Order</span> Summary
        </h1>
        <div className="mt-4">
          ...
          <h2 className="text-center mt-5 text-gray-400 dark:text-gray-400">
            <Lock className="w-5 h-5 text-gray-400 dark:text-gray-400 inline-block mr-1" /> Secure Checkout
          </h2>
        </div>
      </div>
    </div>
